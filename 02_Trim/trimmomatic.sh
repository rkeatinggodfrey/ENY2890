...
trimmed_{Reverse_Read_R2}_001.fastq.gz trimmed_unpaired_{Reverse_Read_R2}.fastq.gz ILLUMINACLIP:TruSeq3-PE.fa:2:30:10:2
:True LEADING:3 TRAILING:3 MINLEN:36